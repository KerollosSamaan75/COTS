...
void LCD_voidSendCmnd(u8 Copy_u8Cmnd)
{
	...
	DIO_u8SetPinValue  (LCD_u8_CONTROL_PORT ,LCD_u8_RW_PIN  ,DIO_u8_LOW);
	/* Write command */
	DIO_u8SendMostNebble(LCD_u8_DATA_PORT , Copy_u8Cmnd);
	/* E = 1 */
	DIO_u8SetPinValue  ( LCD_u8_CONTROL_PORT ,LCD_u8_E_PIN  ,DIO_u8_HIGH);
	_delay_us(10);
	/* E = 0 */
	...
	DIO_u8SetPinValue  (LCD_u8_CONTROL_PORT ,LCD_u8_RW_PIN  ,DIO_u8_LOW);
	/* Write command */
	DIO_u8SendMostNebble(LCD_u8_DATA_PORT , Copy_u8Cmnd << 4);
	/* E = 1 */
	DIO_u8SetPinValue  ( LCD_u8_CONTROL_PORT ,LCD_u8_E_PIN  ,DIO_u8_HIGH);
	_delay_us(10);
	/* E = 0 */
...
void LCD_voidSendChar(u8 Copy_u8Char)
{
	...
	DIO_u8SetPinValue  (LCD_u8_CONTROL_PORT ,LCD_u8_RW_PIN  ,DIO_u8_LOW);
	/* Write char */
	DIO_u8SendMostNebble(LCD_u8_DATA_PORT , Copy_u8Char);
	/* E = 1 */
	DIO_u8SetPinValue  ( LCD_u8_CONTROL_PORT ,LCD_u8_E_PIN  ,DIO_u8_HIGH);
	_delay_us(10);
	/* E = 0 */
	...
	DIO_u8SetPinValue  (LCD_u8_CONTROL_PORT ,LCD_u8_RW_PIN  ,DIO_u8_LOW);
	/* Write char */
	DIO_u8SendMostNebble(LCD_u8_DATA_PORT , Copy_u8Char << 4);
	/* E = 1 */
	DIO_u8SetPinValue  ( LCD_u8_CONTROL_PORT ,LCD_u8_E_PIN  ,DIO_u8_HIGH);
	_delay_us(10);
	/* E = 0 */
