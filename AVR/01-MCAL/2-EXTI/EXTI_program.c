...
u8 EXTI_u8EXTIDisable(u8 Copy_u8EXTIIndex)
{
	...
	switch(Copy_u8EXTIIndex)
	{
		case EXTI_u8_INT0:CLR_BIT(EXTI_u8_GICR,INT0); break;
		case EXTI_u8_INT1:CLR_BIT(EXTI_u8_GICR,INT1); break;
		case EXTI_u8_INT2:CLR_BIT(EXTI_u8_GICR,INT2); break;
		default:Local_u8ErrorState = STD_TYPES_NOK;
	}
	return Local_u8ErrorState;
