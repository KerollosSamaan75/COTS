...
u8  DIO_u8TogglePin(u8 Copy_u8PortId, u8 Copy_u8PinId )
{
	...
	if((Copy_u8PortId <=  DIO_u8_PORTD)&&(Copy_u8PinId <= DIO_u8_PIN7))
	{
		switch(Copy_u8PortId)
		{
			case DIO_u8_PORTA : TOG_BIT(DIO_u8_PORTA,Copy_u8PinId);break;
			case DIO_u8_PORTB : TOG_BIT(DIO_u8_PORTB,Copy_u8PinId);break;
			case DIO_u8_PORTC : TOG_BIT(DIO_u8_PORTC,Copy_u8PinId);break;
			case DIO_u8_PORTD : TOG_BIT(DIO_u8_PORTD,Copy_u8PinId);break;
		}
	}
	else
	{
...
u8 DIO_u8SendMostNebble(u8 Copy_u8PortId, u8 Copy_u8Status )
{
	...
	if((Copy_u8PortId <=  DIO_u8_PORTD)
	{
		switch (Copy_u8PortId)
        {
			case DIO_u8_PORTA : DIO_u8_PORTA &= 0x0F; DIO_u8_PORTA |= Copy_u8Status ; break;
			case DIO_u8_PORTB : DIO_u8_PORTB &= 0x0F; DIO_u8_PORTB |= Copy_u8Status ; break;
			case DIO_u8_PORTC : DIO_u8_PORTC &= 0x0F; DIO_u8_PORTC |= Copy_u8Status ; break;
			case DIO_u8_PORTD : DIO_u8_PORTD &= 0x0F; DIO_u8_PORTD |= Copy_u8Status ; break;
        }
	}
    else
	{
...
u8   DIO_u8SendLeastNebble   (u8 Copy_u8PortId, u8 Copy_u8Status)
{
	...
	if((Copy_u8PortId <=  DIO_u8_PORTD)
	{
		switch (Copy_u8PortId)
        {
			case DIO_u8_PORTA : DIO_u8_PORTA &= 0xF0; DIO_u8_PORTA |= Copy_u8Status ; break;
			case DIO_u8_PORTB : DIO_u8_PORTB &= 0xF0; DIO_u8_PORTB |= Copy_u8Status ; break;
			case DIO_u8_PORTC : DIO_u8_PORTC &= 0xF0; DIO_u8_PORTC |= Copy_u8Status ; break;
			case DIO_u8_PORTD : DIO_u8_PORTD &= 0xF0; DIO_u8_PORTD |= Copy_u8Status ; break;
        }
	}
    else
	{
